...
init -1 python hide:
    ...
    config.window_title = u"mints"
    config.window_icon = "mintslogo.png" #in ../game directory, 256x256
    ...
    ## respectively.
    style.menu_window.xpos=200
    style.window.background = Solid(((0, 0, 0)))
...
python early:
    config.save_directory = "mints-1468730789"
...
init -1 python hide:
    ...
    style.menu_choice_button.background = Solid(((0, 0, 0)))
    style.menu_choice_button.hover_background = Solid(((0, 0, 0)))
    # style.menu_choice_button.yminimum = 60
    style.menu_choice_button.xalign = 1.0
    style.menu_choice_button.yalign = 0.0
    style.menu_choice_button.left_margin = 300
